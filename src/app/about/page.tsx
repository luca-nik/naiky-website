    ...
    <div className="about-page">
      <div className="about-container">
        ...
        <div className="about-achievements">
          <h2>Achievements</h2>
          <p><a href="https://scholar.google.com/citations?user=SsTwaqEAAAAJ&hl=en&oi=ao" target="_blank" rel="noopener noreferrer">8 peer-reviewed journal articles</a>, 3 international conference presentations, 1 Italian National patent.</p>
